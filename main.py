...
if __name__ == '__main__':
    ...
    elif config == 'TinyImagenet':
        from configs.TinyImagenet import get_args_parser
        config_parser = subparser.add_parser('TinyImagenet', help='Split-CIFAR100 L2P configs')
    
    elif config == 'Imagenet-R':
        from configs.Imagenet_R import get_args_parser
        config_parser = subparser.add_parser('Imagenet-R', help='Split-CIFAR100 L2P configs')
