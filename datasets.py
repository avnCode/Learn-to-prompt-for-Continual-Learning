...
def build_continual_dataloader(args):
    ...
    if args.dataset.startswith('Split-'):
        if args.name == 'Split-CIFAR100':  
          dataset_train, dataset_val = get_dataset(args.dataset.replace('Split-',''), transform_train, transform_val, args)
        elif args.name == 'TinyImagenet':  
          dataset_train, dataset_val = get_dataset('TinyImagenet', transform_train, transform_val, args)

        elif args.name == 'Imagenet-R':  
          dataset_train, dataset_val = get_dataset('Imagenet-R', transform_train, transform_val, args)
